...
/// Space loot spawner. A bunch of rarer seeds.
/obj/effect/spawner/lootdrop/space/rareseed
	lootcount = 5
	loot = list(
		/obj/item/seeds/random = 30, // /obj/item/seeds/random is not a random seed, but an exotic seed.
		...
		/obj/item/seeds/hemp = 5,
		/obj/item/seeds/hemp/rgb = 1,
		/obj/item/seeds/hemp/death = 1,
		/obj/item/seeds/hemp/life = 1,
		/obj/item/seeds/hemp/omega = 1,
...
/obj/effect/spawner/lootdrop/contraband
	...
	loot = list(
		...
		/obj/item/food/grown/hemp/rgb = 1,
		/obj/item/food/grown/hemp/life = 1,
