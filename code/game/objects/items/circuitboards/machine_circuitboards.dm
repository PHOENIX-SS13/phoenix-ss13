...
/obj/item/circuitboard/machine/vendor
	...
	var/static/list/vending_names_paths = list(
		...
		/obj/machinery/vending/boozeomat/syndicate_access = "suspicious Booze-O-Mat",
		...
		/obj/machinery/vending/cola/sodie = "Bepis",
		/obj/machinery/vending/cola/sodie/dr_gibb = "Dr. Gibb",
		/obj/machinery/vending/cola/sodie/starkist = "Star-kist",
