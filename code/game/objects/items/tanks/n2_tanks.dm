...
/obj/item/tank/internals/nitrogen/belt
	icon = 'icons/horizon/obj/tank.dmi'
	lefthand_file = 'icons/horizon/mob/inhands/equipment/tanks_lefthand.dmi'
	righthand_file = 'icons/horizon/mob/inhands/equipment/tanks_righthand.dmi'
