...
/datum/unit_test/machine_disassembly/Run()
	var/obj/machinery/freezer = allocate(/obj/machinery/atmospherics/components/binary/heat_pump/freezer)
	...
	TEST_ASSERT(locate(/obj/item/circuitboard/machine/heat_pump) in freezer_location, "Couldn't find the circuit board when disassembling freezer")
