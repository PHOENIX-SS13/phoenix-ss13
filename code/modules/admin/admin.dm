...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	if (M.client)
		if(!isnewplayer(M))
			...
			body += "\[ Construct: <A href='byond://?_src_=holder;[HrefToken()];simplemake=constructjuggernaut;mob=[REF(M)]'>Juggernaut</A> , "
			body += "<A href='byond://?_src_=holder;[HrefToken()];simplemake=constructartificer;mob=[REF(M)]'>Artificer</A> , "
