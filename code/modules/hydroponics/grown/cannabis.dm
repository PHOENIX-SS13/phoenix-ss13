...
/obj/item/seeds/cannabis
	...
	growthstages = 1
	instability = 40
	growing_icon = 'icons/obj/hydroponics/growing_cannabis.dmi'
...
/obj/item/seeds/cannabis/rainbow
	...
	mutatelist = list()
	reagents_add = list(/datum/reagent/colorful_reagent = 0.05, /datum/reagent/medicine/psicodine = 0.03, /datum/reagent/drug/happiness = 0.1, /datum/reagent/toxin/mindbreaker = 0.1, /datum/reagent/drug/cannabis = 0.15)
	rarity = 40
