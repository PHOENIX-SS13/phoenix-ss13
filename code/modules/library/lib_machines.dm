...
/obj/machinery/computer/bookmanagement/ui_interact(mob/user)
	...
	switch(screenstate)
		if(0)
			...
			dat += "<A href='byond://?src=[REF(src)];savepainting=1'>8. Upload Paintings to Archive</A><BR>"
			if(obj_flags & EMAGGED)
				dat += "<A href='byond://?src=[REF(src)];switchscreen=9'>9. Access the Forbidden Lore Vault</A><BR>"
