/obj/item/skillchip/job/research_director
	...
	skill_icon = "dumbbell"
	activate_message = SPAN_NOTICE("You realise if you apply the correct force, at the correct angle, it is possible to make the immovable permanently movable.")
	deactivate_message = SPAN_NOTICE("You forget how to permanently anchor a paradoxical object.")
