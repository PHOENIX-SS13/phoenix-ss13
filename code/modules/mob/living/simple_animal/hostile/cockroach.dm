...
/mob/living/simple_animal/hostile/cockroach/hauberoach/make_squashable()
	AddComponent(/datum/component/squashable, squash_chance = 100, squash_damage = 1, squash_callback = /mob/living/simple_TYPE_PROC_REF(animal/hostile/cockroach/hauberoach,on_squish))
