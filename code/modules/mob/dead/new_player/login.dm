/mob/dead/new_player/Login()
	...
	if (!client.holder && CONFIG_GET(flag/panic_bunker) && CONFIG_GET(flag/panic_bunker_interview) && !(client.ckey in GLOB.interviews.approved_ckeys) && !client.prefs.interview_accepted)
