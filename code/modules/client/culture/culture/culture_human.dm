...
/datum/cultural_info/culture/generic_human
	...
	additional_langs = list(HUMAN_CULTURAL_LANGUAGES)
...
/datum/cultural_info/culture/tau_ceti
	...
	element in Ceti society resulting in a large cybernetics culture; it is not uncommon to see many Cetites sporting some chrome."
	economic_power = 1.1
...
/datum/cultural_info/culture/luna_rich
	...
	description = "You are from Luna, Earth's only natural satellite and home to some of the richest, most highly cultured, or influential people of humanity. Fortunately for you, you are one of this elite and well \
...
/datum/cultural_info/culture/terran
	...
	required_lang = list(/datum/language/russian, /datum/language/terrum)
	economic_power = 0.9
