...
/datum/preferences/proc/announce_conflict(list/notadded)
	to_chat(parent, "<span class='warningplain'><b><u>Keybinding Conflict</u></b></span>\n\
					<span class='warningplain'><b>There are new <a href='byond://?_src_=prefs;preference=tab;tab=3'>keybindings</a> that default to keys you've already bound. The new ones will be unbound.</b></span>")
...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["phoenix_toggles"], phoenix_toggles)
	...
	phoenix_toggles = sanitize_integer(phoenix_toggles, 0, (2**24)-1, initial(phoenix_toggles))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["phoenix_toggles"], phoenix_toggles)
