...
/atom/movable/screen/plane_master/above_lighting_mouse_transparent
	name = "above lighting mouse transparent plane master"
	plane = ABOVE_LIGHTING_MOUSE_TRANSPARENT_PLANE
	appearance_flags = PLANE_MASTER //should use client color
	blend_mode = BLEND_OVERLAY
	mouse_opacity = MOUSE_OPACITY_TRANSPARENT
