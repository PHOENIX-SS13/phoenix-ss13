...
/**
 * Similar to capitalizeAll, this takes a string and replaces only first letters
 * capitalized for use in titles.
 *
 * @param {string} str
 * @return {string} The string with Title Casing applied.
 */
