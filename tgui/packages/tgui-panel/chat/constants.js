...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector: '.alert, .minorannounce, .syndradio, .centcomradio, .aiprivradio, .comradio, .secradio, .engradio, .medradio, .sciradio, .suppradio, .servradio, .broadcastradio, .radio, .deptradio, .binarysay, .newscaster, .resonate',
  },
  {
